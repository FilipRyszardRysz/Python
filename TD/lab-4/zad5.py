...
print("ASK 3dB: ", bobo.szerokoscPasma(wartosci_za_FFT, 3))
print("ASK 6dB: ", bobo.szerokoscPasma(wartosci_za_FFT, 6))
print("ASK 12dB: ", bobo.szerokoscPasma(wartosci_za_FFT, 12))

print("PSK 3dB: ", bobo.szerokoscPasma(wartosci_zp_FFT, 3))
print("PSK 6dB: ", bobo.szerokoscPasma(wartosci_zp_FFT, 6))
print("PSK 12dB: ", bobo.szerokoscPasma(wartosci_zp_FFT, 12))

print("FSK 3dB: ", bobo.szerokoscPasma(wartosci_zf_FFT, 3))
print("FSK 6dB: ", bobo.szerokoscPasma(wartosci_zf_FFT, 6))
print("FSK 12dB: ", bobo.szerokoscPasma(wartosci_zf_FFT, 12))
